...
study @.agent/tasks/phase3-document-pipeline.md and pick the most important task to do and work on it
...
when tests pass, commit and mark the task complete in .agent/tasks/phase3-document-pipeline.md, dont move to the next task!